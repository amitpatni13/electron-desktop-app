...
@Component({
    selector: 'app-bill-format-two',
    templateUrl: './billFormatTwo.html',
    styleUrls: ['./billFormatTwo.scss']
})
export class BillFormatTwoComponent implements OnInit, OnChanges, OnDestroy {
    ...
    @Output() dragDrop = new EventEmitter<string>();
